...
DATASETS_DICT = {"openimages": "OpenImages", "cityscapes": "CityScapes", 
                 "jetimages": "JetImages", "evaluation": "Evaluation", "insatpress":"InsatPress"}
...
# Define custom Dataset (INSAT Press)
class InsatPress(BaseDataset):

    files = {"train": "train", "test": "test", "val": "val"}

    def __init__(self, mode, root=os.path.join(DIR, 'data/insatpress'), crop_size=256,
                 normalize=False, **kwargs):
        super().__init__(root, [transforms.ToTensor()], **kwargs)
